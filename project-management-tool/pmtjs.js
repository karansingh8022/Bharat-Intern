document.addEventListener('DOMContentLoaded', function () {
    ...
    const users = ['Karan', 'Kshitiz', 'Saurabh'];
    const tasks = [
        { name: 'Study', assignedTo: 'Karan', assignedBy: 'Kshitiz' },
        { name: 'Read', assignedTo: 'Kshitiz', assignedBy: 'Saurabh' },
        { name: 'Play', assignedTo: 'Saurabh', assignedBy: 'Karan' }
    ];
